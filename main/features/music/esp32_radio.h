...
// Base class/interface (make sure this is the correct header in your project)
#include "radio.h"
...
private:
    ...
    std::vector<uint8_t> dec_out_buffer_;
    ...
    // ID3 tag handling (MP3)
    size_t SkipId3Tag(uint8_t* data, size_t size);

    // FFT data buffer pointer (owned/managed by display)
